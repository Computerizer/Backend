...
class computer(models.Model):
    ...
    ssd1          = models.ForeignKey(ssd, null=True, blank=True, on_delete= models.CASCADE)
    ssd2          = models.ForeignKey(ssd, null=True, blank=True, on_delete= models.CASCADE)
    hdd1          = models.ForeignKey(hdd, null=True, blank=True, on_delete= models.CASCADE)
    hdd2          = models.ForeignKey(hdd, null=True, blank=True, on_delete= models.CASCADE)
    psu           = models.ForeignKey(psu, on_delete= models.CASCADE)
    fan1          = models.ForeignKey(fan, null=True, blank=True, on_delete= models.CASCADE)
    fan2          = models.ForeignKey(fan, null=True, blank=True, on_delete= models.CASCADE)
    fan3          = models.ForeignKey(fan, null=True, blank=True, on_delete= models.CASCADE)
